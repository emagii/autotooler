...
static const char mconf_readme[] = N_("Overview\n"
                                      "--------\n"
                                      "Some features may be built directly into autotooler. Some features\n"
...
N_("\n" "For various reasons, one may wish to keep several different autotooler\n" "configurations available on a single machine.\n" "\n" "If you have saved a previous configuration in a file other than the\n" "autotooler's default, entering the name of the file here will allow you\n" "to modify that configuration.\n" "\n"
...
N_("\n" "For various reasons, one may wish to keep different autotooler\n" "configurations available on a single machine.\n" "\n" "Entering a file name here will allow you to later retrieve, modify\n" "and use the current configuration as an alternate to whatever\n" "configuration options you have selected at that time.\n" "\n"
...
static void set_config_filename(const char *config_filename)
{
    ...
    sym = sym_lookup("AT_VERSION", 0);
    sym_calc_value(sym);
    size = snprintf(menu_backtitle, sizeof (menu_backtitle),
                    _("%s - autotooler v%s Configuration"),
...
int main(int ac, char **av)
{
    ...
    case 0:
        if (conf_write(filename)) {
            fprintf(stderr, _("\n\n"
                              "Error during writing of the autotooler configuration.\n"
                              "Your autotooler configuration changes were NOT saved."
                              "\n\n"));
            return 1;
        }
    case -1:
        printf(_("\n\n"
                 "*** End of autotooler configuration.\n"
                 "*** Execute 'make' to build autotooler or try 'make help'."
                 "\n\n"));
        break;
    default:
        fprintf(stderr, _("\n\n"
